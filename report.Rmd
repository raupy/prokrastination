...
Teilnehmer in absoluten Zahlen:
```{r}
...
23 Teilnehmer nutzen regelmäßig Social-Media-Kanäle zum prokrastinieren. Dies macht einen Anteil von ungefähr 27% aus. In der Regel werden meistens mehrere Services gleichzeitig genutzt. Hier ist Instagram mit Abstand am meisten vertreten. Außerdem werden noch Facebook, Twitter, TikTok, Snapchat und sonstige verwendet.
...
Bei der Frage, wie zufrieden die Teilnehmer mit ihren Prüfungsergebnissen sind, scheint es keinen Effekt zu haben, wie viel in der Zeit prokrastiniert wurde. Die meisten Teilnehmer waren mit ihrer Prüfungsphase zufrieden oder wenigsten empfanden sie ihre Ergebnisse ausreichend. Hier konnten wir erkennen, dass es bei den ausreichend zufriedenen Teilnehmern mehr prokrastiniert wurde, als bei den Zufriedenen. 
Wir vermuten, dass hier keine Korrelation sichtbar ist, weil Studierende, die viel prokrastinieren und dann gute oder ausreichende Ergebnisse erzielen trotzdem zufrieden sind, weil sie wissen, dass sie viel prokrastiniert haben und wenig gelernt haben und Andere, die wenig prokrastiniert haben und trotzdem keine sehr guten Ergebnisse haben, dann weniger zufrieden sind. Sollten sie jedoch sehr gute Ergebnisse erhalten sind sie ebenfalls zufrieden.
...
Nach unseren Ergebnissen unterscheidet sich das Prokrastinationsverhalten zwischen Bachelor und Master kaum. Hier konnten wir erstaunlich ähnliche Verteilungen unter den verschiedenen angestrebten Abschlüssen feststellen. Selbst bei den Staatsexamen, die eigentlich sehr unterrepräsentiert sind in unserem Teilnehmerfeld, zeichnet sich sehr deutlich das gleiche Muster ab.
Zwei Drittel der Teilnehmer gaben außerdem an, dass sich das Prokrastinationsverhalten im gegensatz zur vorherigen Prüfungsphase nicht verändert hat.

```{r}
plot.abschluss.prokrastination(c(4:15), "dodge", "Häufigkeit (Anzahl)")
```

Bei den Bachelor und Masterstudierenden haben wir genug Teilnehmer um die Angaben vergleichbar zu machen. Bei den Staatsexamen leider eigentlich zu wenige. Trotzdem ist die Verteilung sehr interessant und ähnlich in allen drei Bereichen.
